...
export default function AddressSearch({
  ...
  color = 'green', gpsButton, onGPS, gpsLoading,
}: Props) {
    ...
    <div className="relative flex items-center gap-2 flex-1">
      <div className="relative flex-1">
        <input
          ...
          className={`w-full px-3 py-2 rounded-xl border text-sm transition outline-none ${
            value ? borderColor + ' font-medium' : 'border-gray-200 hover:border-gray-300'
          } ${value ? (color === 'green' ? 'text-green-800' : 'text-red-800') : 'text-gray-700'}`}
        />
      ...
      {gpsButton && (
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-600 border border-blue-200 transition flex-shrink-0 disabled:opacity-50"
        >
          {gpsLoading
